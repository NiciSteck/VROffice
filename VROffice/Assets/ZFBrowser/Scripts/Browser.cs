...
#pragma warning restore 618
	...
	/// <param name="action"></param>
	public void PressKey(KeyCode key, KeyAction action = KeyAction.PressAndRelease, EventModifiers modifier = EventModifiers.None)
	{
		...
		/*public void SendMouseClick(Vector2 position, int mouseButton)
		{
			var ev = new Event()
			{
